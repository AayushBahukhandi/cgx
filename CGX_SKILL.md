...
> Auto-generated by cgx on 2026-06-21T14:40:45.681495+00:00. Do not edit manually.
...
- **Indexed:** 2026-06-21T14:40:45.681495+00:00
- **Nodes:** 881 (685 functions,
  106 classes, 87 files)
- **Edges:** 2615
- **Languages:** rust 90%, typescript 8%, python 2%, javascript 0%
- **Communities:** 68
- **Dead code candidates:** 695 (395 high confidence · safe to investigate)
...
- `crates/cgx-cli/src/main.rs` — churn 0.77, 52 callers
- `crates/cgx-engine/src/graph.rs` — churn 0.35, 43 callers
- `crates/cgx-engine/src/lib.rs` — churn 0.31, 41 callers
- `crates/cgx-mcp/src/tools.rs` — churn 0.23, 43 callers
- `crates/cgx-engine/src/parsers/ts.rs` — churn 0.27, 40 callers
