...
> Auto-generated by cgx on 2026-05-10T16:02:38.388863+00:00. Do not edit manually.
...
- **Indexed:** 2026-05-10T16:02:38.388863+00:00
- **Nodes:** 770 (537 functions,
  83 classes, 74 files)
- **Edges:** 4493
- **Languages:** rust 88%, typescript 10%, python 2%, javascript 0%
- **Communities:** 131
- **Dead code candidates:** 0 (0 high confidence · safe to investigate)
...
- `crates/cgx-mcp/src/tools.rs` — churn 0.33, 134 callers
- `crates/cgx-engine/tests/test_skill.rs` — churn 0.33, 74 callers
- `crates/cgx-engine/tests/test_graph.rs` — churn 0.28, 68 callers
- `packages/web-ui/src/types/graph.ts` — churn 0.17, 69 callers
- `crates/cgx-engine/tests/test_parser.rs` — churn 0.17, 67 callers
