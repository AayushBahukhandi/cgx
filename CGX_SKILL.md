...
> Auto-generated by cgx on 2026-05-10T08:27:19.369212+00:00. Do not edit manually.
...
- **Indexed:** 2026-05-10T08:27:19.369212+00:00
- **Nodes:** 630 (487 functions,
  72 classes, 69 files)
- **Edges:** 2240
- **Languages:** rust 87%, typescript 10%, python 2%, javascript 0%
- **Communities:** 53
- **Dead code candidates:** 466 (260 high confidence · safe to investigate)
...
- `crates/cgx-cli/src/main.rs` — churn 0.75, 44 callers
- `crates/cgx-mcp/src/tools.rs` — churn 0.38, 43 callers
- `crates/cgx-cli/src/tui/graph_widget.rs` — churn 0.31, 42 callers
- `crates/cgx-engine/src/skill.rs` — churn 0.38, 36 callers
- `crates/cgx-cli/src/tui/layout.rs` — churn 0.25, 42 callers
